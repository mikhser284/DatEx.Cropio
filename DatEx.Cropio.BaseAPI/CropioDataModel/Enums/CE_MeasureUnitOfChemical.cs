...
using E = DatEx.Cropio.BaseAPI.CE_MeasureUnitOfChemical;

namespace DatEx.Cropio.BaseAPI
{
    /// <summary> Ед. измерения химикатов </summary>
    public enum CE_MeasureUnitOfChemical
    {
    ...
    public class JsonConverter_MeasureUnitOfChemical : JsonConverter
    {
    ...
    public static class EnumConverter_MeasureUnitOfChemical
    {
